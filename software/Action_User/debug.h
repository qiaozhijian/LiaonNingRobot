...
void d_Sub_Box(int Ball_counter,int maxFirstlayer,int c_Aimxfirst,int Aimxfirst,int Aimyfirst,int maxSecondlayer,int c_Aimxsecond,int Aimxsecond,int Aimysecond);
